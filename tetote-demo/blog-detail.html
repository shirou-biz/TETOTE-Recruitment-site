                        ...
                        <div class="page-blog-detail_post">
                            <article>
                                <div class="blog__list-item_content">
                                    <div class="blog__list-item_content-blog-detail-wrapper">
                                ...
                                <div class="blog__list-item_text">
                                    <p>
                                        2023年3月25日、新入社員を対象とした入社前研修を実施しました。<br>
                                        今回の研修では、社会人としての基礎知識やビジネスマナー、当社の事業内容や社風について学びました。
                                    </p>
                                    <h2>研修内容</h2>
                                    <ul>
                                        <li>挨拶、自己紹介</li>
                                    ...
                                    <h2>研修の様子</h2>
                                    <p>
                                        研修は、座学とグループワーク、懇親会を通して行いました。<br>
                                    ...
                                    <h2>今後の期待</h2>
                                    <p>
                                        今回の研修で学んだことを活かして、新入社員の皆さんが、一人前の社会人として成長していくことを期待しています。<br>
