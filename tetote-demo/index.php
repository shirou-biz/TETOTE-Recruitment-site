            ...
            <div class="header-inner" id="header">
                <h1 class="header__logo">
                    <a href="<?php echo esc_url( home_url('/') ); ?>">
                        <img src="<?php echo esc_url(get_theme_file_uri('images/tetote-logo-white.png')); ?>" alt="株式会社TETOTE" id="logo-img">
                    </a>
                </h1>
            ...
            <div class="global-menu-inner">
                <div class="global-menu-wrapper">
                    <div class="global-menu__logo">
                        <a href="<?php echo esc_url( home_url('/') ); ?>" class="global-menu__logo-inner">
            ...
            <div class="main-inner">
                <div class="fv">
                    <div class="fv__bg">
                        <div class="fv__bg-item">
                            <img src="<?php echo esc_url(get_theme_file_uri('images/fv01.jpeg')); ?>" alt="">
                        </div>
                        <div class="fv__bg-item">
                            <img src="<?php echo esc_url(get_theme_file_uri('images/fv02.jpeg')); ?>" alt="">
                        </div>
                    </div>
                        ...
                        <div class="fv__main">
                            ...
                            <div class="fv__main_news">
                                <div class="fv__main_news-inner">
                                    ...
                                    <a href="<?php echo esc_url( home_url('/blog') ); ?>" class="fv__main_news-more">
                                        <div><p class="en">VIEW MORE</p></div>
                                        <img src="<?php echo esc_url(get_theme_file_uri('images/arrow 7.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="fv__slider">
                        <div class="fv__slider-box">
                            <div class="fv__slider-item"><img src="<?php echo esc_url(get_theme_file_uri('images/slide01.jpeg')); ?>" alt=""></div>
                            <div class="fv__slider-item"><img src="<?php echo esc_url(get_theme_file_uri('images/slide02.jpeg')); ?>" alt=""></div>
                            <div class="fv__slider-item"><img src="<?php echo esc_url(get_theme_file_uri('images/slide03.jpeg')); ?>" alt=""></div>
                        </div>
                    ...
                    <div class="fv__message">
                        ...
                        <a href="<?php echo esc_url( home_url('/about-us') ); ?>" class="more-btn hover">
                ...
                <section class="member">
                    <div class="member-inner">
                        ...
                        <div class="member__slider">
                            <div class="member__slider-box">
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/staff-01-nishimura') ); ?>" class="staff-card">
                                        <div class="staff-card_image">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain01.jpeg')); ?>" alt="">
                                        </div>
                                ...
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/staff-02-hashimoto') ); ?>" class="staff-card">
                                        <div class="staff-card_image">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain02.jpeg')); ?>" alt="">
                                        </div>
                                        <div class="staff-card_message-wrapper">
                                            <div class="staff-card_message1">
                                                <p>全力で考えぬける環境</p>
                                ...
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/staff-03-aoki') ); ?>" class="staff-card">
                                        <div class="staff-card_image">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain03.jpeg')); ?>" alt="">
                                        </div>
                                        <div class="staff-card_message-wrapper">
                                            <div class="staff-card_message1">
                                                <p>お客様も知らない課題を</p>
                                ...
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/') ); ?>staff-04-sasaki.html" class="staff-card">
                                        <div class="staff-card_image reverse">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain04.jpeg')); ?>" alt="">
                                        </div>
                                        <div class="staff-card_message-wrapper">
                                            <div class="staff-card_message1">
                                                <p>「あなたが担当で良かった」</p>
                                ...
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/') ); ?>staff-05-takada.html" class="staff-card">
                                        <div class="staff-card_image">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain05.jpeg')); ?>" alt="">
                                        </div>
                                        <div class="staff-card_message-wrapper">
                                            <div class="staff-card_message1">
                                                <p>どんな難解な案件も</p>
                                ...
                                <div class="member__slider-item">
                                    <a href="<?php echo esc_url( home_url('/') ); ?>staff-06-tachibana.html" class="staff-card">
                                        <div class="staff-card_image">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/syain06.jpeg')); ?>" alt="">
                                        </div>
                                        <div class="staff-card_message-wrapper">
                                            <div class="staff-card_message1">
                                                <p>お客様と一緒に開発</p>
                        ...
                        <div class="more-btn-wrapper">
                            <a href="<?php echo esc_url( home_url('/') ); ?>staff.html" class="more-btn hover">
                                <div><p class="more-btn-text en">VIEW MORE</p></div>
                                <img src="<?php echo esc_url(get_theme_file_uri('images/arrow 7.svg')); ?>" alt="">
                            </a>
                        </div>                        
                ...
                <section class="benefits">
                    ...
                    <div class="benefits__content">
                        <a href="<?php echo esc_url( home_url('/') ); ?>career.html" class="benefits__content-item">
                            <div class="benefits__content-item_main">
                                ...
                                <div class="benefits__content-item_main-img">
                                    <img src="<?php echo esc_url(get_theme_file_uri('images/career 1.png')); ?>" alt="">
                                </div>
                        ...
                        <a href="<?php echo esc_url( home_url('/') ); ?>benefits.html" class="benefits__content-item">
                            <div class="benefits__content-item_main">
                                <div class="benefits__content-item_main-bg"></div>
                                <p class="benefits__content-item_main-en en">Employee Benefits</p>
                                <div class="benefits__content-item_main-img">
                                    <img src="<?php echo esc_url(get_theme_file_uri('images/welfare 1.png')); ?>" alt="">
                                </div>
                                <div class="benefits__content-item_main-arrow"></div>
                                <div class="benefits__content-item_main-title">
                                    <p>福利厚生</p>
                    ...
                    <div class="blog-inner">
                        ...
                        <ul class="blog__list">
                            <li class="blog__list-item">
                                <article>
                                    <div class="blog__list-item_img">
                                        <img src="<?php echo esc_url(get_theme_file_uri('images/blog01.jpeg')); ?>" alt="">
                                    </div>
                                    <div class="blog__list-item_content">
                                        <a href="" class="blog__list-item_content-tag">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/categorry1.png')); ?>" alt="">
                                            <div><p class="blog__list-item_content-tag-category">社内研修</p></div>
                                        </a>
                                        <a  href="<?php echo esc_url( home_url('/blog/article-1') ); ?>" class="blog__list-item_content-title">
                                            新入社員向けに、入社前研修を行いました。
                                        </a>
                            ...
                            <li class="blog__list-item">
                                <article>
                                    <div class="blog__list-item_img">
                                        <img src="<?php echo esc_url(get_theme_file_uri('images/blog02.jpeg')); ?>" alt="">
                                    </div>
                                    <div class="blog__list-item_content">
                                        <a href="" class="blog__list-item_content-tag">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/categorry1.png')); ?>" alt="">
                                        ...
                                        <a  href="<?php echo esc_url( home_url('/blog/article-2') ); ?>" class="blog__list-item_content-title">
                                            内定者向け研修を行いました。
                                        </a>
                            ...
                            <li class="blog__list-item">
                                <article>
                                    <div class="blog__list-item_img">
                                        <img src="<?php echo esc_url(get_theme_file_uri('images/blog03.jpeg')); ?>" alt="">
                                    </div>
                                    <div class="blog__list-item_content">
                                        <a href="" class="blog__list-item_content-tag">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/categorry1.png')); ?>" alt="">
                                        ...
                                        <a  href="<?php echo esc_url( home_url('/blog/article-3') ); ?>" class="blog__list-item_content-title">
                            ...
                            <li class="blog__list-item">
                                <article>
                                    <div class="blog__list-item_img">
                                        <img src="<?php echo esc_url(get_theme_file_uri('images/blog04.jpeg')); ?>" alt="">
                                    </div>
                                    <div class="blog__list-item_content">
                                        <a href="" class="blog__list-item_content-tag">
                                            <img src="<?php echo esc_url(get_theme_file_uri('images/categorry1.png')); ?>" alt="">
                                        ...
                                        <a  href="<?php echo esc_url( home_url('/blog/article-4') ); ?>" class="blog__list-item_content-title">
                                            【新卒採用2024】エントリー受付中！
                                        </a>
                        ...
                        <div class="blog__more">
                            <a href="<?php echo esc_url( home_url('/blog') ); ?>" class="blog__more-btn"></a>
                    ...
                    <div class="recruitment-inner">
                        ...
                        <div class="recruitment__content">
                            <div class="recruitment__content-upper">
                                <a href="<?php echo esc_url( home_url('/details') ); ?>" class="more-btn hover">
                                    <div>
                                        <p class="more-btn-text">募集要項</p>
                                    </div>
                                    <img src="<?php echo esc_url(get_theme_file_uri('images/arrow 7.svg')); ?>" alt="">
                                </a>
                                <a href="<?php echo esc_url( home_url('/faq') ); ?>" class="more-btn hover">
                                    <div>
                            ...
                            <div class="recruitment__content-lower">
                                <a href="<?php echo esc_url( home_url('/about-us#companyprofile') ); ?>" class="more-btn hover">
                                    <div>
                ...
                <div class="cta">
                    <div class="cta__img">
                        <img src="<?php echo esc_url(get_theme_file_uri('images/cta 1.jpeg')); ?>" alt="">
                    </div>
                    <div class="cta__main">
                        ...
                        <a href="<?php echo esc_url( home_url('/entry') ); ?>" class="entry-btn hover">
                            <div>
                                <p class="en">ENTRY</p>
                            </div>
                            <img src="<?php echo esc_url(get_theme_file_uri('images/arrow 7.svg')); ?>" alt="">
