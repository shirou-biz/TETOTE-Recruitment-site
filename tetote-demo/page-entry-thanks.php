...
<html lang="ja">
    <head>
        <meta charset="UTF-8">
        <title>サンクスページ | 株式会社TETOTE</title>
            ...
            <div class="main-inner case-entry">
                ...
                <div class="page-entry">
                    <div class="page-entry-inner">
                        <section class="page-entry-content case-entry-thanks">
                            <div class="page-entry-content_header case-entry-thanks">
                                <h2 class="page-entry-content_header-title case-entry-thanks">送信ありがとうございました。</h2>
                                <p class="page-entry-content_header-sub">3営業日以内に人事担当者より連絡させていただきます。</p>
                            </div>
                        </section>
                    </div>
                </div>
